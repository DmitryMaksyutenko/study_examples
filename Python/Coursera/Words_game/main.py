...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['ANT', 'BOX', 'SOB', 'TO'], 'tot')
    False
    """
...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'SOX')
    False
    """
...
def board_contains_word(board, word):
    ...
    True
    >>> oard_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'NSA')
    False
    """
    return board_contains_word_in_row(board, word) or \
           board_contains_word_in_column(board, word)
...
def word_score(word):
    ...
    elif word_len in [7, 8, 9]:
        word_score = word_len * 2
    elif word_len in [3, 4, 5, 6]:
        word_score = word_len
...
def num_words_on_board(board, words):
    ...
    3
    >>> num_words_on_board([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], ['AS', 'BOX', 'SOB', 'TO'])
    3
    """
    words_number = 0
    for word in words:
